...
<body style="text-align: center">
	...
	<form action="/JavaEE_JspTest/ShoppingServlet?type=updateBook&"
		method="post">
	...
	%>
			<tr>
				...
				<td><input type="text" name="booknum"
					value="<%=book.getBuyNums() %>" />本</td>
				<td><a
					href="/JavaEE_JspTest/ShoppingServlet?type=deleteBook&id=<%=book.getId() %>">刪除</a></td>
			</tr>
			<%     
	}      
	%>
