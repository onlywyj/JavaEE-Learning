...
public class Employee implements Serializable {
	...
	public String toString() {
		return "Employee [id=" + id + ", empId=" + empId + ", empName=" + empName + ", empGender=" + empGender
				+ ", empPassword=" + empPassword + ", empGrade=" + empGrade + ", empEmail=" + empEmail
				+ ", empDepartmentId=" + empDepartmentId + ", department=" + department + "]";
	}
