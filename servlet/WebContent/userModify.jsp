...
<body>
	...
	<div class="container">
		<div class="row clearfix">
			...
			<form class="form-horizontal" action="UserServlet?type=modify"
				method="post">
				<div class="col-sm-offset-2">
					<div class="form-group">
						<input type="hidden" value=${user.id } name="id" /> <label
							for="inputUserName" class="col-sm-2 control-label">姓名：</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="username"
								id="inputUserName" value=${user.username } placeholder="姓名">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="password" class="form-control" name="password"
								id="inputPassword" value=${user.password }  placeholder="密码">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="grade"
								id="inputGrade" value=${user.grade } placeholder="等级">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="email" class="form-control" name="email"
								id="inputEmail" value=${user.email } placeholder="邮箱">
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-offset-4 col-sm-10">
							<button type="submit" class="btn btn-success pull-center"
								name="submit">确定</button>
							<button type="reset" class="btn btn-warning pull-center"
