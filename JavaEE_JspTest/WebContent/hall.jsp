...
<body style="text-align:center">
	<h1>欢迎购物</h1>     
	<form action='/JavaEE_JspTest/ShoppingServlet?type=showMyCart' method='post'>     
	<table border='1' style="border-collapse: collapse;margin: auto">      
	<tr><th>书名</th><th>作者</th><th>出版社</th><th>价格</th><th>剩余数量 </th><th>购买</th></tr>     
	<%       
	...
	%>      
		<tr>       
			...
			<td><%=book.getPrice()%></td>       
			<td><%=book.getNums()%></td>      
			<td><a href='/JavaEE_JspTest/ShoppingServlet?type=addBook&id= <%=book.getId() %>'>购买</a></td>      
			</tr>     
	<%     
	}      
	%>
	<tr><td colspan='6'><input type='submit' value='查看购物车 '/></td></tr>      
	</table>     
	</form>     
